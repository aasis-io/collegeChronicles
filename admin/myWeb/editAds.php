...
$retrieveData = $advertisement->getById();
...
if (isset($_POST['submit'])) {
  ...
  $result = $advertisement->edit();
  if (is_integer($result)) {
    $ErrMs = "";
    $msg = "Advertisement updated Successfully with id " . $result;
  } else {
    $msg = "";
  }
}
...
<main id="main" class="main">
  ...
  <section class="section">
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title"><strong>Edit</strong> Advertisement</h5>
          <form role="form" id="submitForm" method="post" enctype="multipart/form-data" noValidate>
            <div class="row mb-3">
              ...
              <div class="col-sm-10"> <input type="number" class="form-control" name="rank" value="<?php echo $retrieveData->rank;  ?>" required></div>
            </div>

            <div class="row mb-3">
              <label for="inputText" class="col-sm-2 col-form-label">Link For Ad</label>
              <div class="col-sm-10"> <input type="link" class="form-control" name="linkforad" value="<?php echo $retrieveData->linkforad;  ?>" required></div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-6" enctype="multipart/form-data"> <input type="hidden" value="<?php echo $retrieveData->image;  ?>" name="old_image">
                <img src="../images/<?php echo $retrieveData->image;  ?>" height="20" width="200" alt="" srcset=""><input class="form-control" type="file" name="image" required>
              </div><label class="col-sm-4" for="" style="color: red;">size of ad</label>
            </div>
            <div class="row mb-3">
              ...
              </div><label class="col-sm-4" for="" style="color: red;">800px * 500px</label>
            </div>
